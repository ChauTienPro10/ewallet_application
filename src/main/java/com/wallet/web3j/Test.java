...
public class Test extends Contract {
    ...
    public static List<TransferEventResponse> getTransferEvents(TransactionReceipt transactionReceipt) {
        ...
        List<Contract.EventValuesWithLog> valueList = (List<EventValuesWithLog>) Contract.staticExtractEventParametersWithLog(TRANSFER_EVENT, logs.get(0)); // Assuming you are interested in the first log
